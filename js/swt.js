...
// if(url.indexOf("/mtbd/") > 0 || url.indexOf("/yltd/") > 0 || url.indexOf("/zxhd/") > 0 || url.indexOf("/ymgs/") > 0 || url.indexOf("/xshy/") > 0 || url.indexOf("/jpks/etbj/") > 0 || url.indexOf("/jobs/") > 0 || url.indexOf("/angel/xfjs/") > 0 || url.indexOf("/angel/xfaq/") > 0 || url.indexOf("/angel/tfya/") > 0 || url.indexOf("/angel/blzd/") > 0 || url.indexOf("/angel/dflz/") > 0 || url.indexOf("/angel/jkjy/") > 0 || url.indexOf("/jpks/") > 0 || url.indexOf("/complaint/") > 0 || url.indexOf("/yjy/") > 0 || url.indexOf("/hlfc/") > 0){
//
// }else{
	document.writeln("<style>");
...
document.writeln("<script language=\"javascript\" src=\"http://mlk.zoosnet.net/JS/LsJS.aspx?siteid=MLK16844568&float=1&lng=cn\"></script>");
function swt_dhaaaaa(obj){
var ins=$(obj).parents("div").attr("id");
var swt="http://mlk.zoosnet.net/LR/Chatpre.aspx?id=MLK16844568&lng=cn&r="+document.referrer+"#swt&p="+window.location.href;
window.open(swt);
}//引用结束(此处应用第三方的聊天工具)
...
//alert(mobileAgent[i]);
          location.href = 'http://wap.tianyunhos.com/';
          break; } }
/*Left*/
